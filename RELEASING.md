...
**Before** copying this file to create a new issue titled `EPP 2026-12 M1` with label `endgame`, update the names and versions, including those in this document.
...
https://github.com/eclipse-simrel/.github/blob/main/wiki/SimRel/2026-12.md)
...
- [ ] On RC1 check "new and noteworthy" version numbers.
  ...
  - [ ] Remember that some of the features will release new versions together with the new Eclipse release.
        ...
        Look at the news links in [2026-12 Participants](https://eclipse.dev/simrel/?file=wiki/SimRel/2026-12_participants.json).
...
- [ ] Sanity check the build for the following:
  ...
  - [ ] Make sure filenames contain expected build name and milestone, e.g., `2026-12-M1`.
  - [ ] Splash screen says the expected release name with no milestone, e.g., `2026-12`.
  - [ ] `Help -> About` says the expected build name and milestone, e.g., `2026-12-M1`.
  ...
  - [ ] Upgrade from previous release works.
    ...
    - `https://download.eclipse.org/staging/2026-12/` -
...
- [ ] Edit the [Jenkins build](https://ci.eclipse.org/packaging/job/epp/job/master/lastBuild/).
  ...
  - [ ] Edit Jenkins Build Information and name it, e.g., `2026-12 M1`.
...
- [ ] Check that this worked:
      copy the composite\*M1.jar files over the composite\*.jar files in https://download.eclipse.org/technology/epp/packages/2026-12/ -
...
- [ ] **24 Hours before Final release** Make sure files are in final location to allow downloads to mirror.
  - [ ] Tag the release, e.g., `2026-12_R`.
        Example command line: `git tag --annotate 2026-12_R -m"2026-12 Release" 1b7a1c1af156e3ac57768b87be258cd22b49456b`.
...
- [ ] Run the [Finalize Release](
  ...
  - The _next_ release sub-directory needs to be created immediately.
    - When 2026-12 is released, a directory 2027-03 must be created with an empty p2 composite repository pointing to 2026-12 until M1.
