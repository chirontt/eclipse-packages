...
By default, the EPP build uses the content of the Eclipse Simultaneous Release _Staging_ repository at <https://download.eclipse.org/staging/2026-12/> as input.
...
the EPP build will read its input from the composite Eclipse 2026-12 repository:

    -Declipse.simultaneous.release.repository="https://download.eclipse.org/releases/2026-12"
